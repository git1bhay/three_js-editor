// copied and modifed from three.js Viewport.ViewHelper.js
// import {
//     THREE
// } from 'pictarize-lib';
...
class OrientationHelper extends THREE.Object3D {
    ...
    constructor(editorCamera, container, controls,scene) {
        ...
        this.scene = scene
        console.log('scene',this.scene,this.controls);



        const panel = document.createElement('div');
        panel.classList.add("view-helper");
        ...
        this.scene.add(posXAxisHelper);
        this.scene.add(posYAxisHelper);
        this.scene.add(posZAxisHelper);
        this.scene.add(negXAxisHelper);
        this.scene.add(negYAxisHelper);
        this.scene.add(negZAxisHelper);
        ...
        this.handleClick = function(event) {
            ...
            mouse.x = ((event.clientX - offsetX) / (rect.right - offsetX)) * 2 - 1; // kim fix
        ...
        function getSpriteMaterial(color, text = 'abhay') {
